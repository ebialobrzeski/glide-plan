...
All transactional emails go through this module. Routes and services should
call the public helpers below — never import `resend` directly.

GlideLog shares the users table and email configuration (RESEND_API_KEY /
RESEND_FROM_ADDRESS) with the main GlidePlan app, so verification codes sent
from either app are interchangeable.
"""
